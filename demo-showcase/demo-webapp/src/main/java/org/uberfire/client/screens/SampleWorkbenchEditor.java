...
import org.uberfire.client.dtable.TextResourceType;
...
@Dependent
@WorkbenchEditor(identifier = "SampleWorkbenchEditor", supportedTypes = {TextResourceType.class}, lockingStrategy = EDITOR_PROVIDED)
